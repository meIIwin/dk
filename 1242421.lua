...
DragonKnight.IsToggled = Menu.AddOptionBool({"Hero Specific", "DragonKnight"}, "Enabled", false)
DragonKnight.optionKillSteal = Menu.AddOptionBool({"Hero Specific", "Dragon Knight"}, "Kill Steal", "Cast breathe fire on enemy to KS", false)
DragonKnight.optionAutoStun = Menu.AddOptionBool({"Hero Specific", "Dragon Knight"}, "Auto Stun", "Auto stun enemy in range", false)
DragonKnight.optionAwareness = Menu.AddOptionBool({"Hero Specific", "Dragon Knight"}, "Awareness", "Show how many hits left to kill enemy")
